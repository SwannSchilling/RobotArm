        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if len(motor_positions) == 8: 
                    ...
                    UpperRing_Arm_Rotation = 1 #round(float(motor_positions[8]), round_value) 
                    MiddleRing_Arm_Rotation = 1 #round(-float(motor_positions[9]), round_value) 
                    LowerRing_Arm_Rotation = 1 #round(-float(motor_positions[10]), round_value)
                    
                    scale_factor_platform = 1
                    y_rotation = 1 #round(-float(motor_positions[11])*scale_factor_platform, round_value)
                    z_rotation = 1 #round(float(motor_positions[12])*scale_factor_platform, round_value)
                    x_rotation = 1 #round(-float(motor_positions[13])*scale_factor_platform, round_value)
