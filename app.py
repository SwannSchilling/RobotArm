...
if ODrive == True:
    ...
    odrv1.axis0.controller.config.calibration_current = 20
    odrv1.axis1.controller.config.calibration_current = 20

    odrv1.axis0.controller.config.current_lim = 20
    odrv1.axis1.controller.config.current_lim = 20
